...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'http://raphbuetalenttalent.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'http://raphbuetalenttalent.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/addTalentSuggestions',

...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'http://raphbuetalentprofile.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'http://raphbuetalentidentity.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
